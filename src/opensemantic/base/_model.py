...
class Article(CreativeWork):
    ...
    related_to: list[str] | None = Field(
        None, json_schema_extra={"title*": {"de": "Bezug zu"}}, title="Related to"
    )
    part_of: list[Article] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Artikelsammlung"},
            "description*": {
...
class HowTo(CreativeWork):
    ...
    rdf_type: list[str] | None = Field(
        ["schema:HowTo"], json_schema_extra={"options": {"hidden": True}}
    )
...
class Tutorial(Article):
    ...
    required_predecessor: list[str] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Voraussetzungen (notwendig)"},
            "eval_template": {
                "type": "mustache",
                "mode": "render",
    ...
    optional_predecessor: list[str] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Voraussetzungen (optional)"},
            "eval_template": {
                "type": "mustache",
                "mode": "render",
    ...
    recommended_successor: list[str] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Nachfolge-Lerneinheit (empfohlen)"},
            "eval_template": {
                "type": "mustache",
                "mode": "render",
...
class EventWithPeople(Event):
    ...
    allday: bool | None = Field(
        False, json_schema_extra={"title*": {"de": "Ganztägig"}}, title="All day"
    )
    start_date: str | date = Field(
        ..., json_schema_extra={"title*": {"de": "Beginn"}}, title="Start"
    )
    start_date_min: str | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Beginnt nach"},
            "options": {
    ...
    event_series: str | None = Field(
        "",
        json_schema_extra={
            "title*": {"de": "Teil von (Ereignisserie)"},
            "description*": {"de": "Die Ereignisserie, zu der dieses Ereignis gehört."},
            "options": {
                "autocomplete": {
    ...
    funding: list[str] | None = Field(
        ...
        json_schema_extra={
            "title*": {"de": "Förderung"},
            "description*": {"de": "Förderung für das Ereignis."},
        },
        title="Funding",
    )
    """
    ...
    funding_name: list[str] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Förderung (Förderkennzeichen oder Bezeichnung)"},
            "description*": {
    ...
    location_name: str | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Ort (Bezeichnung)"}},
        title="Location (name)",
    )
    url: str | None = Field(
        None,
        json_schema_extra={"description*": {"de": "Link zur Event Homepage"}},
        title="URL",
    )
    """
    ...
    participants: set[str] | None = Field(
        {""},
        json_schema_extra={"title*": {"de": "Teilnehmer*innen"}},
        title="Participants",
    )
    minutes_taker: set[str] | None = Field(
        {""},
        json_schema_extra={"title*": {"de": "Protokollant*innen"}},
        title="Minutes taker",
    )
    organizer: set[str] | None = Field(
        {""},
        json_schema_extra={
            "title*": {"de": "Organisator*innen"},
            "description*": {
    ...
    associated_ou: set[str] | None = Field(
        {""},
        json_schema_extra={
            "title*": {"de": "Assoziierte Organisationseinheit(en)"},
            "description*": {
...
class RepeatPattern(OswBaseModel):
    ...
    by_month: list[Month] | None = Field(
        ...
        json_schema_extra={
            "title*": {"de": "Nach Monat"},
            "description*": {"de": "Monat(e), in dem das Ereignis stattfinden soll."},
        },
        title="By month",
    )
    """
    ...
    except_dates: list[date] | None = Field(
        None, json_schema_extra={"title*": {"de": "Ausnahmen"}}, title="Excepttions"
    )
    repeat_count: conint(ge=1) | None = Field(
        1, json_schema_extra={"title*": {"de": "Wiederholungen"}}, title="Repeat count"
    )
    schedule_timezone: str | None = Field(
        "Europe/Berlin (CET = UTC+1)",
        json_schema_extra={"title*": {"de": "Zeitzone"}},
        title="Timezone",
    )
...
class Step(OswBaseModel):
    ...
    step_name: str | None = Field(
        None, json_schema_extra={"title*": {"de": "Name"}}, title="Name"
    )
    step_description: str | None = Field(
        None, json_schema_extra={"title*": {"de": "Beschreibung"}}, title="Description"
    )
...
class Recipe(HowTo):
    ...
    output_count: int | None = Field(
        None, json_schema_extra={"title*": {"de": "Portionen"}}, title="Yield"
    )
    preparation_duration: str | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Vorbereitungszeit"}},
        title="Preparation time",
    )
    processing_duration: str | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Verarbeitungszeit"}},
        title="Processing time",
    )
    total_duration: str | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Gesamtdauer"}},
        title="Total duration",
    )
    input: list[str] | None = Field(
        None, json_schema_extra={"title*": {"de": "Zutaten"}}, title="Ingredients"
    )
    steps: list[Step] | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Zubereitungsschritte"}},
        title="Steps",
    )
...
class Distribution(OswBaseModel):
    model_config = ConfigDict(
        json_schema_extra={"title": "Distribution"},
    )
...
class Dataset(Data):
    ...
    themes: list[Entity] | None = Field(
        None, json_schema_extra={"range": "Category:Entity"}, title="Themes / Topics"
    )
    """
    ...
    data_format: list[DataFormat] | None = Field(
        None,
        json_schema_extra={"range": "Category:OSWccac243b31f94574847861e5d9685b82"},
        min_length=1,
        title="Data format",
    )
    """
    ...
    dataset_schema: list[DatasetSchema] | None = Field(
        None,
        json_schema_extra={"range": "Category:OSW0d6584b3e2b64e9595733c4c3963c486"},
        min_length=1,
...
class DataFormat(DataTerm):
    ...
    specification: str | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Spezifikation"},
            "description*": {"de": "Entweder Text oder Link"},
        },
        title="Specification",
    )
    """
...
class BuildingFunction(Item):
    model_config = ConfigDict(
        json_schema_extra={"title": "BuildingFunction"},
    )
...
class AreaUsageType(Item):
    ...
    din277_label: list[str] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "DIN 277 Bezeichnung"},
            "desciption": "Label according to DIN 277",
            "description*": {"de": "Bezeichnung nach DIN 277"},
        },
        title="DIN 277 label",
    )
...
class Building(Location):
    ...
    construction_year: float | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Baujahr", "en": "Construction year"},
            "description*": {
    ...
    length: float | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Länge", "en": "Length"}},
        title="Length",
    )
    width: float | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Breite", "en": "Width"}},
        title="Width",
    )
    height: float | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Höhe", "en": "Height"}},
        title="Height",
    )
    footprint: float | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Grundfläche", "en": "Area at base level"}},
        title="Area at base level",
    )
    area: float | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Gesamtfläche", "en": "Total floor area"}},
        title="Total floor area",
    )
    function: set[BuildingFunction] | None = Field(
        None,
        json_schema_extra={
            "title*": {"en": "Building function", "de": "Gebäudefunktion"},
    ...
    responsible_person: set[User] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Verantwortliche Person", "en": "Responsible person"},
...
class Room(Location):
    ...
    usage_type: set[AreaUsageType] | None = Field(
        None,
        json_schema_extra={
            "title*": {"en": "Room usage type", "de": "Raumnutzungsart"},
    ...
    area: float | None = Field(
        None, json_schema_extra={"title*": {"de": "Fläche", "en": "Area"}}, title="Area"
    )
    door_width: float | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Türbreite", "en": "Door width"}},
        title="Door width",
    )
    door_height: float | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Türhöhe", "en": "Door height"}},
        title="Door height",
    )
    number: str | None = Field(
        None,
        json_schema_extra={"title*": {"en": "Number", "de": "Nummer"}},
        title="Number",
    )
    usage: set[RoomUsage] | None = Field(
        None,
        json_schema_extra={
            "title*": {"en": "Room usage", "de": "Raumnutzung"},
...
class User(Person, UserAccount):
    ...
    superior: set[User] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Führungsperson(en)"},
            "description*": {"de": "Direkte Führungsperson(en)"},
            "range": "Category:OSWd9aa0bca9b0040d8af6f5c091bf9eec7",
        },
        title="Superior(s)",
    )
    ...
    employment_contract_status: EmploymentStatus | None = Field(
        default_factory=lambda: EmploymentStatus.model_validate(
            "Item:OSW62770459451644f3841c502df8a5cb1d"
        ),
        json_schema_extra={
            "title*": {"de": "Status des Arbeitsvertrages"},
            "description*": {
...
class Attribute(OswBaseModel):
    ...
    attribute_name: list[Label] = Field(..., min_length=1, title="Name")
...
class DeviceType(PhysicalItemType):
    ...
    typical_processes: list[str] | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Typische Prozesse"}},
        title="Typical Processes",
    )
    manufacturer_type_id: str | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Hersteller Typen-ID"},
            "description*": {"de": "Produkt-ID des Herstellers."},
        },
    ...
    manufacturer_type_name: str | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Hersteller Typenbezeichnung"},
            "description*": {
...
class Device(Tool, PhysicalItem):
    ...
    responsible_person: list[Person] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Verantwortliche Person(en)"},
            "range": "Category:OSW44deaa5b806d41a2a88594f562b110e9",
        },
        title="Responsible Person",
    )
    ...
    organizational_unit: list[Group] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Organisationseinheit(en)"},
    ...
    inventory_number: str | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Inventarnummer"}},
        title="Inventory Number",
    )
    risk_assessment: RiskAssessmentProcess | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Gefährdungsbeurteilung"},
    ...
    serial_number: str | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Seriennummer"}},
        title="Serial Number",
    )
    """
    ...
    owner: str | None = Field(
        None, json_schema_extra={"title*": {"de": "Eigentümer"}}, title="Owner"
    )
...
class Group(OrganizationalSubUnit):
    ...
    manager: set[str] | None = Field(
        None,
        json_schema_extra={"title*": {"en": "Head", "de": "Leitung"}},
        title="Head",
    )
...
class RiskAssessmentProcess(AdministrativeProcess):
    ...
    output: list[str] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Ausgabe-Dokumente"},
            "description*": {"de": "Laborordnung oder Betriebsanweisung"},
        },
...
class MaterialConstituent(OswBaseModel):
    ...
    default: str | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Standardwert"}},
        title="Default value",
    )
...
class StrictParticipantsProcessType(ProcessType):
    ...
    orderer_default: OrganizationalUnit | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Auftraggeber (Standardwert)"},
            "description*": {
    ...
    contact_default: Person | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Ansprechpartner (Standardwert)"},
            "description*": {"de": "Kontakt seitens Auftraggeber"},
            "range": "Category:OSW44deaa5b806d41a2a88594f562b110e9",
    ...
    approver_default: list[Person] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Genehmiger*in (Standardwert)"},
            "description*": {
...
class ShipmentItem(OswBaseModel):
    ...
    item_type: Category | None = Field(
        default_factory=lambda: Category.model_validate("Category:Item"),
        json_schema_extra={
            "title*": {"de": "Typ"},
            "range": "Category:Category",
            "options": {
...
class Shipment(Item):
    ...
    """
    description: list[Description] | None = Field(
        None, json_schema_extra={"propertyOrder": 4}
    )
    dispatch_date: AwareDatetime = Field(
        ...,
        json_schema_extra={
            "title*": {"de": "Versanddatum"},
            "description*": {"de": "Wird im automatisch generierten Label verwendet."},
            "dynamic_template": "{{_now_}}",
            "options": {"dynamic_template": {"override": "empty"}},
            "propertyOrder": 5,
        },
    ...
    sender: OrganizationalUnit | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Absender-Organisation"},
            "description*": {
    ...
    recipient: OrganizationalUnit | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Empfänger-Organisation"},
            "description*": {
                "de": "Akronym der Organisation ist erforderlich für die Erstellung des Versandetikett."
            },
            "range": "Category:OSW3cb8cef2225e403092f098f99bc4c472",
    ...
    shipment_status: ShipmentStatus | None = Field(
        default_factory=lambda: ShipmentStatus.model_validate(
            "Item:OSWaf335426cb8e44e9a3b109bcdc881bb4"
        ),
        json_schema_extra={
            "title*": {"de": "Status"},
            "description*": {"de": 'Status der Sendung, z.B. "In Transit".'},
    ...
    """
    arrival_date: AwareDatetime | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Ankunftsdatum"}, "propertyOrder": 80},
        title="Arrival date",
    )
    included_items: list[ShipmentItem] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Sendungsinhalt"},
            "options": {
                "enable_array_copy": True,
                "array_copy_ignore": ["uuid", "attachments"],
            },
...
class ShippingServiceProvider(Role):
    ...
    tracking_system_link: AnyUrl | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Link zur Sendungsverfolgung"},
            "eval_template": [
                {
                    "type": "wikitext",
                    "mode": "render",
...
class DatabaseSchemaEntry(OswBaseModel):
    ...
    type: str | None = Field(
        "Category:OSWc1dc531bc4e84d409d9ee5719b3b7632",
        json_schema_extra={"options": {"hidden": True}},
    )
    """
    ...
    schema_name: str = Field(
        ..., json_schema_extra={"title*": {"de": "Schema-Name"}}, title="Schema name"
    )
...
class Database(Software):
    ...
    name: str = Field(
        ...,
        json_schema_extra={
            "title*": {"de": "Der eindeutige bezeichner der Datenbank"},
    ...
    db_schema: list[DatabaseSchemaEntry] | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Datenbank-Schema"}},
        title="Database schema",
    )
    activated_extension: set[str] | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Aktivierte Erweiterung"},
            "watch": {"server": "server"},
        },
        min_length=1,
...
class WebService(Software):
    ...
    hosted_software: list[Software] | None = Field(
        None,
        json_schema_extra={"range": "Category:OSW77e749fc598341ac8b6d2fff21574058"},
        min_length=1,
        title="Hosted Software",
    )
    host: list[Host] | None = Field(
        None,
        json_schema_extra={"range": "Category:OSW02590972aeba46d7864ed492c0c11384"},
        min_length=1,
        title="Hosts",
    )
...
class DatabaseServer(WebService):
    ...
    db_type: list[str] | None = Field(
        None,
        json_schema_extra={"title*": {"en": "Database type", "de": "Datenbanktyp"}},
        min_length=1,
        title="Database type",
    )
    installed_extension: list[str] | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Installierte Erweiterung"}},
        min_length=1,
...
class DataSoftware(Software, DataTool):
    model_config = ConfigDict(
        json_schema_extra={"title": "DataSoftware"},
    )
...
class DatabaseSchema(DatabaseTerms):
    ...
    database: list[str] | None = Field(
        [""],
        json_schema_extra={"title*": {"de": "Datenbank"}},
        min_length=1,
        title="Database",
    )
    """
...
class Grant(IntangibleItem):
    ...
    rdf_type: list[str] | None = Field(
        ["schema:Grant"], json_schema_extra={"options": {"hidden": True}}
    )
...
class FundingCall(IntangibleItem):
    ...
    urls: str | None = Field(
        None,
        json_schema_extra={"title*": {"de": "Ausschreibungstext (Link)"}},
        title="Call text (url)",
    )
...
class Association(NonGovernmentalOrganization):
    ...
    manager: list[Person] | None = Field(
        None,
        json_schema_extra={
            "title*": {"en": "President", "de": "Präsident:in"},
            "description*": {
...
class University(EducationalOrganization):
    ...
    manager: list[Person] | None = Field(
        None,
        json_schema_extra={
            "title*": {"en": "Rector / president", "de": "Rektor:in / Präsident:in"},
            "description*": {
...
class Faculty(OrganizationalSubUnit):
    ...
    manager: list[Person] | None = Field(
        None,
        json_schema_extra={"title*": {"en": "Dean", "de": "Dekan:in"}},
        title="Dean",
    )
    superordinate_ou: list[str] | None = Field(
        [""],
        json_schema_extra={
            "description*": {"en": "University", "de": "Universität oder Hochschule"}
        },
        min_length=1,
    )
    """
...
class InstitutePostalAddress(OswBaseModel):
    ...
    country: str | None = Field(
        None,
        json_schema_extra={"title*": {"en": "Country", "de": "Land"}},
        title="Country",
    )
    state: str | None = Field(
        None,
        json_schema_extra={"title*": {"en": "State", "de": "Bundesland"}},
        title="State",
    )
    region: str | None = Field(
        None,
        json_schema_extra={"title*": {"en": "Region", "de": "Region"}},
        title="Region",
    )
    ...
    city: str | None = Field(
        None, json_schema_extra={"title*": {"en": "City", "de": "Stadt"}}, title="City"
    )
    street_name: str | None = Field(
        None,
        json_schema_extra={"title*": {"en": "Street", "de": "Straße"}},
...
class Institute(OrganizationalSubUnit):
    ...
    member_of: set[str] | None = Field(
        None,
        json_schema_extra={
            "title*": {"en": "Member of", "de": "Mitglied in"},
            "description*": {
    ...
    site: set[str] | None = Field(
        None,
        json_schema_extra={"title*": {"en": "Site", "de": "Standort"}},
        title="Site",
    )
    superordinate_ou: set[str] | None = Field(
        None,
...
class Requirement(Item):
    ...
    requirement_category: str | None = Field(
        None,
        json_schema_extra={
            "title*": {"de": "Anforderungskategorie"},
            "options": {
                "autocomplete": {
    ...
    related_to: list[str] | None = Field(
        ...
        json_schema_extra={
            "title*": {"de": "Bezug zu"},
            "description*": {"de": "Lose Verbindung zu einer anderen Anforderung"},
        },
        title="Related to",
    )
    """
...
EventWithPeople.model_rebuild()
Externalperson.model_rebuild()
Faculty.model_rebuild()
Floor.model_rebuild()
Foundation.model_rebuild()
Function.model_rebuild()
FundingCall.model_rebuild()
GovermentOrganization.model_rebuild()
Grant.model_rebuild()
Group.model_rebuild()
Host.model_rebuild()
HowTo.model_rebuild()
...
Role.model_rebuild()
Room.model_rebuild()
RoomUsage.model_rebuild()
Shipment.model_rebuild()
ShipmentItem.model_rebuild()
ShipmentStatus.model_rebuild()
ShippingServiceProvider.model_rebuild()
Site.model_rebuild()
Slot.model_rebuild()
...
StrictParticipantsProcess.model_rebuild()
StrictParticipantsProcessType.model_rebuild()
TargetObject.model_rebuild()
Task.model_rebuild()
TaskStatus.model_rebuild()
TaxIdAndCountry.model_rebuild()
Tool.model_rebuild()
Tool.model_rebuild()
ToolMaintenanceEvent.model_rebuild()
Topic.model_rebuild()
Tutorial.model_rebuild()
University.model_rebuild()
User.model_rebuild()
VatIdAndCountry.model_rebuild()
WebService.model_rebuild()
