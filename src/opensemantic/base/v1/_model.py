...
from pydantic.v1 import AnyUrl, EmailStr, Field, confloat, conint, constr
...
class TaxIdAndCountry(OswBaseModel):
    class Config:
        schema_extra = {
            "title": "TaxIdAndCountry",
            "title*": {"en": "Tax ID and country", "de": "Steuer-ID und Land"},
        }
...
class VatIdAndCountry(OswBaseModel):
    class Config:
        schema_extra = {
            "title": "VatIdAndCountry",
            "title*": {"en": "VAT ID and country", "de": "USt-ID und Land"},
        }
...
class OrganizationalUnit(Item):
    ...
    tax_id_obj: list[TaxIdAndCountry] | None = Field(
        None,
    ...
    """
    vat_id_obj: list[VatIdAndCountry] | None = Field(
        None,
...
class Room(Location):
    ...
    usage_type: set[AreaUsageType] | None = Field(
        None,
        range="Category:OSWae92be81cdb34d22844d4791ef790d93",
...
class Attribute(OswBaseModel):
    ...
    attribute_name: list[Label] = Field(..., min_items=1, title="Name")
    quantity_prop: Quantity


class Constituent(OswBaseModel):
    class Config:
        schema_extra = {
            "title": "Constituent",
            "title*": {"de": "Bestandteil"},
            "headerTemplate": "{{i1}} - {{self.name}}",
        }

    uuid: UUID = Field(default_factory=uuid4, options={"hidden": True}, title="UUID")
    property: str | None = Field("Property:HasPart", options={"hidden": True})
    is_array: bool | None = Field(None, title="Is array")
    name: str = Field(..., title="Name")
    type: Material | None = Field(
        None,
        field_comment="Material",
        options={
            "autocomplete": {
    ...
    default: str | None = Field(None, title="Default value")
...
class Process(Item):
    ...
    duration: timedelta | None = Field(None, title="Duration", title_={"de": "Dauer"})
    end_date_time: datetime | None = Field(
...
class Project(Item):
    ...
    abstract: list[Description] | None = Field(
        None,
        eval_template={
            "type": "mustache-wikitext",
            "mode": "render",
...
class MaterialConstituent(OswBaseModel):
    class Config:
        schema_extra = {
            "title": "MaterialConstituent",
            "title*": {"de": "Materialbestandteil"},
            "headerTemplate": "{{i1}} - {{self.name}}",
        }
    ...
    default: str | None = Field(
        None, title="Default value", title_={"de": "Standardwert"}
    )
...
class MaterialType(PhysicalItemType):
    ...
    constituents: list[MaterialConstituent] | None = Field(
        None,
...
# generated by datamodel-codegen:
#   filename:  OSWa2c8dd387d0b4a0c807a5a7bde190ba3.json
...
class ShipmentLabel(OswBaseModel):
    class Config:
        schema_extra = {
            "title": "ShipmentLabel",
            "title*": {"en": "Shipment label", "de": "Sendungslabel"},
        }
...
class ShipmentItem(OswBaseModel):
    class Config:
        schema_extra = {
            "title": "ShipmentItem",
            "title*": {"de": "Sendungsgegenstand"},
            "defaultProperties": [],
        }
...
class Shipment(Item):
    ...
    label: list[ShipmentLabel] = Field(
        ...,
        description_={
    ...
    included_items: list[ShipmentItem] | None = Field(
        None,
        eval_template=[
            {
                "type": "mustache-wikitext",
...
class DatabaseSchemaEntry(OswBaseModel):
    class Config:
        schema_extra = {"title": "DatabaseSchemaEntry"}
...
class DataChannel(OswBaseModel):
    ...
    name: str = Field(
        ..., description_={"de": "Technischer Name / Schlüsselwort"}, title="Name"
    )
    """
    ...
    characteristic: CharacteristicType | None = Field(
        ...
        field_comment="range CharacteristicType, subclass_of range Characteristic for convenience.",
...
class DataTool(Tool):
    ...
    data_channels: list[DataChannel] | None = Field(
        None,
        options={"enable_array_copy": True, "array_copy_ignore": ["uuid", "osw_id"]},
        title="DataChannels",
        title_={"en": "Data channels", "de": "Datenkanäle"},
    )
...
class Database(Software):
    ...
    db_schema: list[DatabaseSchemaEntry] | None = Field(
...
class InstitutePostalAddress(OswBaseModel):
    class Config:
        schema_extra = {
            "eval_template": {
                "type": "wikitext",
    ...
    country: str | None = Field(
        None, title="Country", title_={"en": "Country", "de": "Land"}
    )
    state: str | None = Field(
        None, title="State", title_={"en": "State", "de": "Bundesland"}
    )
    region: str | None = Field(
        None, title="Region", title_={"en": "Region", "de": "Region"}
    )
    post_office_box_no: float | None = Field(
        None,
        title="PO box number",
        title_={"en": "PO box number", "de": "Postfach nummer"},
    )
    ...
    city: str | None = Field(None, title="City", title_={"en": "City", "de": "Stadt"})
    street_name: str | None = Field(
        None, title="Street", title_={"en": "Street", "de": "Straße"}
    )
    house_no: str | None = Field(
...
class Institute(OrganizationalSubUnit):
    ...
    """
    postal_address: InstitutePostalAddress | None = Field(
        None,
        defaultProperties=[
            "uuid",
            "street_name",
...
MaterialConstituent.update_forward_refs()
...
ShipmentItem.update_forward_refs()
...
TaxIdAndCountry.update_forward_refs()
...
VatIdAndCountry.update_forward_refs()
